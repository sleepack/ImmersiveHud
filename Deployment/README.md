Quick fix for 1.0 for [ImerrsiveHud Continued](https://thunderstore.io/c/valheim/p/Taakefyrsten/ImmersiveHud/) mod by Taakefyrsten

Should work fine with vanilla, [EquipmentAndQuickSlots](https://thunderstore.io/c/valheim/p/RandyKnapp/EquipmentAndQuickSlots/) and [BetterUI](https://thunderstore.io/c/valheim/p/Zenox/BetterUI/), not sure about other

Fixed source code fork: [https://github.com/sleepack/ImmersiveHud](https://github.com/sleepack/ImmersiveHud)
